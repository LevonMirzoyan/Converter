def converter(num):
    ...
    hundred = [100, 'сто', 'сот']
    thousand = [hundred[0] * 10, 'тысяча', 'тысяч,']
    million = [thousand[0] * 1000, 'миллион', 'миллионов,']
    billion = [million[0] * 1000, 'миллиард', 'миллиардов,']
    trillion = [billion[0] * 1000, 'триллион', 'триллионов,']
    if num < 20:
        return digit[num]
    if num < 100:
